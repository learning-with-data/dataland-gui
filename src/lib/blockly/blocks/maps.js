...
function MapsBlocks(generate_data_columns) {
  ...
  blocks["maps_set_latitude"] = {
    init: function () {
      this.jsonInit({
        message0: "set ‘latitude’ of map marker to %1",
        args0: [
          {
            type: "field_dropdown",
  ...
  blocks["maps_set_longitude"] = {
    init: function () {
      this.jsonInit({
        message0: "set ‘longitude’ of map marker to %1",
        args0: [
          {
            type: "field_dropdown",
            name: BLOCKARG_MAPS_COLUMN,
  ...
  blocks["maps_set_size"] = {
    init: function () {
      this.jsonInit({
        message0: "set size of map marker to %1",
        args0: [
          {
            type: "field_dropdown",
            name: BLOCKARG_MAPS_COLUMN,
  ...
  blocks["maps_set_color"] = {
    init: function () {
      this.jsonInit({
        message0: "set color of map marker to %1",
        args0: [
          {
            type: "field_dropdown",
            name: BLOCKARG_MAPS_COLUMN,
